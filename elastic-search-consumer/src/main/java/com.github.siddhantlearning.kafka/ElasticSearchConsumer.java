...
public class ElasticSearchConsumer {
    ...
    public static RestHighLevelClient createClient(){
        ...
        String hostname = "kafka-course-23469202.eu-west-1.bonsaisearch.net:443"; // localhost or bonsai url
        String username = "5jokinhi1i"; // needed only for bonsai
        String password = "po9em7qioj"; // needed only for bonsai
    ...
    public static KafkaConsumer<String, String> createConsumer(String topic){
        ...
        properties.setProperty(ConsumerConfig.ENABLE_AUTO_COMMIT_CONFIG, "false"); // this is to disable auto commit of offsets
        properties.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "10"); // this is to disable auto commit of offsets
